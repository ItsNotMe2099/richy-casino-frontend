...
function BlackKing(props: Props) {
  return (
    <svg viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M41 21C41 25.9706 36.9706 30 32 30C27.0294 30 23 25.9706 23 21C23 21 25.25 25.5001 32 25.5001C38.75 25.5 41 21 41 21Z" fill="#121027"/>
      <circle cx="14" cy="21" r="9" fill="#2C2B3E"/>
      <path d="M23 21C23 25.9706 18.9706 30 14 30C9.02944 30 5 25.9706 5 21C5 21 7.25 25.5001 14 25.5001C20.75 25.5 23 21 23 21Z" fill="#121027"/>
