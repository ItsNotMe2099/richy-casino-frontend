...
function BlackKnight(props: Props) {
  return (
    <svg viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="17.5" cy="12.5" r="1.5" fill="#2C2B3E"/>
      <path d="M22 4L10.7626 16.1738C10.2723 16.705 10 17.4014 10 18.1243C10 19.7125 11.2875 21 12.8757 21H19.871C21.0468 21 22 20.0468 22 18.871V18V22C17 22 12 25 12 32C12 43.5 12 36.5 12 36.5H34V20.5V19C34 12.3726 28.6274 7 22 7V4Z" fill="#262534"/>
      <path d="M12.8757 21H19.871C21.0469 21 22.0001 20.0468 22.0001 18.871V16C22.0001 16 22.0001 20 19.0001 20H15C13.5002 20 12.8757 21 12.8757 21Z" fill="#090815"/>
      ...
      <path d="M17 13.6577C17 13.2944 17.2944 13 17.6577 13H20.5C20.7761 13 21 13.2239 21 13.5C21 13.7761 20.7761 14 20.5 14H19.1808C19.0607 14 18.9411 14.0147 18.8246 14.0438L17.8172 14.2957C17.4021 14.3995 17 14.0855 17 13.6577Z" fill="#090815"/>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M18.9173 28.3135C18.2403 29.1925 18 30.2895 18 31H15C15 29.8407 15.3597 28.1329 16.4827 26.6747C17.5915 25.2349 19.3844 24.1255 22 24V26.8101C20.4016 26.9233 19.4827 27.5793 18.9173 28.3135Z" fill="#393D54"/>
    </svg>
  )
}
