...
function BlackPawn(props: Props) {
  return (
    <svg viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M29 13C29 16.3137 26.3137 19 23 19C19.6863 19 17 16.3137 17 13C17 13 18.5 16.0001 23 16C27.5 16 29 13 29 13Z" fill="#121027"/>
