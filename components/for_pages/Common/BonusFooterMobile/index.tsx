...
export default function BonusFooterMobile(props: Props) {
  ...
  return (
    <div className={classNames(styles.root, bannerClass)}
      ...
      <div className={styles.content}>
        ...
        {appContext.showBonus && <div className={styles.timer}><Timer minutes style={'footerSmall'} expiredAt={expiredAt}/></div>}
      </div>
    </div>
  )
}
