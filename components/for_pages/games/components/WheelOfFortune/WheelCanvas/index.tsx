...
import { WheelCanvasStyle } from 'components/for_pages/games/components/WheelOfFortune/WheelCanvas/styles'
import { WheelData } from 'components/for_pages/games/components/WheelOfFortune/Wheel/types'
import { clamp } from 'components/for_pages/games/components/WheelOfFortune/utils'
...
const drawWheel = (
  ...
  if (canvas?.getContext('2d')) {
    ...
    const startAngle = 0
    const outsideRadius = canvas.width / 2 - 0
