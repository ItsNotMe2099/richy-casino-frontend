    ...
    <>
      <div className={styles.list}>
            {props.options.map((item, index) => (
              <MenuItem link={item.link} label={item.label} onClick={item.onClick} className={styles.menuItem} key={index}/>
            ))
          }
          ...
          <ButtonDotsWithOverflow dropDownClassName={classNames(styles.dropDown, props.dropDownClassName)}>
